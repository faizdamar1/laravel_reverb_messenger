                        ...
                        >
                            ...
                            {isVideo(attachment) && (
                                <div className='relative flex justify-center items-center'>
                                    ...
                                    <div className='absolute left-0 top-0 right-0 w-full h-full bg-black/50 z-10'></div>
                            ...
                            {isPdf(attachment) && (
                                <div className='relative flex justify-center items-center'>
                                    <div className='absolute left-0 top-0 right-0 bottom-0 w-full h-full bg-black/50 z-10'></div>
...
export default MessageAtatchments